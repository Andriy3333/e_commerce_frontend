...
import { userOrderHistoryColumns } from './user_order_history_columns';
        ...
        <Table>
          <TableHeader>
            {table.getHeaderGroups().map((headerGroup) => (<TableRow key={headerGroup.id}>
                {headerGroup.headers.map((header) => (<TableHead key={header.id} className='text-sm py-1 cursor-pointer' onClick={() => table.setSorting([{ id: header.id, desc: true }]) // Allow dynamic sorting by clicking on the column
                }>

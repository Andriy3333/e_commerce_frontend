...
const EditAmountInStock = ({ item, refreshItems, }) => {
      ...
      <DialogContent className='sm:max-w-[425px]'>
        ...
        <div className='grid gap-4 py-4'>
          <div className='grid grid-cols-4 items-center gap-4'>
            ...
            <Input id='item-quantity' type='number' min={0} max={1000000} value={quantity} onChange={handleQuantityChange} className='col-span-3'/>
          </div>
        </div>

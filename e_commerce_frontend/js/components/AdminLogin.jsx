...
const AdminLogin = () => {
    ...
    return (<div className='flex justify-center items-center min-h-screen py-6'>
        ...
        <form onSubmit={handleSubmit}>
          <CardContent className='space-y-2'>
            <div className='space-y-1'>
              ...
              <Input id='login-username' value={username} onChange={(e) => setUsername(e.target.value)} placeholder='Enter username'/>
            </div>
            <div className='space-y-1'>

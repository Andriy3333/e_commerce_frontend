...
interface EditAmountOrderedProps {
  itemID: number; // The ID of the item to edit
  quantity: number; // The maximum available quantity
}

const EditAmountOrdered = ({ itemID, quantity }: EditAmountOrderedProps) => {
